...
#define STRING_CONFIG_H_AUTHOR "(Exellent, default config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // ET4 Autotune PID results
     ...
     // ET4 Autotune PID results NEW Hotend
...
#define DEFAULT_bedKp 70.94
#define DEFAULT_bedKi 13.04
#define DEFAULT_bedKd 257.27
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1, 80.1, 403.1, 382.165 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 50, 30 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000 , 1500, 50, 3000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -8.5, -1.23 }
...
#define Y_MAX_POS Y_BED_SIZE+17
